...
{
      "selected": false,
      "text": "07.08.2023 | 13:58 Uhr",
      "value": "07.08.2023 | 13:58 Uhr"
}
}
;
local filled_size = 
...
;
g.dashboard.new("NDR MV | TV Instagram | Top Reels und Videos")
...
g.panel.text.new("") // text Panel
  ...
  + g.panel.text.queryOptions.withDatasource("datasource", "-- Mixed --")
...
g.panel.stat.new("KPI Visits") // stat Panel
  ...
  + g.panel.stat.standardOptions.color.withFixedColor("#006400")
  ...
  + g.panel.stat.panelOptions.withTitle("KPI Visits")
